...
function AV_ScanAllItems()
    ...
    Print("  2. Run: .\\utilities\\BuildMasterFromGroupIDs.ps1")
    Print("")
    Print("PowerShell will filter by Group ID (10 groups, ~4,221 items):")
    Print("  Combat Pets (5 groups):")
    ...
    Print("  Other Collectibles (5 groups):")
    Print("    • 134217728 = Non-Combat Companions (Sigils, etc.)")
    Print("    • 67108864/671088640 = Mounts")
    Print("    • 167772160 = Books of Ascension")
    Print("========================================")
end

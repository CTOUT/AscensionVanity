...
## 📜 Historical Tags (Pre-Convention)

### Legacy Tags (Before November 2025)

**These tags were created before the `release/` convention was adopted:**

```
v1.0.0        # First release (kept for historical reference)
v2.0          # v2.0 stable release
v2.0.0-beta   # v2.0 beta release
```

**Decision:** **Keep as-is** ✅

**Reasoning:**
- Already published and may be referenced in documentation
- Users may have bookmarked release URLs
- Don't want to break existing links
- Historical accuracy - represents pre-convention era
- Minimal confusion (clearly dated before v2.1-beta)

### Convention Start Date

**New convention starts:** November 3, 2025 with `release/v2.1-beta`

**All future releases will use:** `release/vX.Y[-suffix]` format
...
- ✅ `v1.0.0` - Keep as-is
- ✅ `v2.0` - Keep as-is
- ✅ `v2.0.0-beta` - Keep as-is

**New Convention (With Prefix):**
- ✅ `release/v2.1-beta` - First release with new convention
- ⏳ `release/v2.2.0` - Future releases
- ⏳ `release/v2.3.0` - Future releases

---

**Last Updated:** November 3, 2025  
**Current Version:** v2.1-beta (tag: release/v2.1-beta)  
**Next Version:** v2.2-dev (future tag: release/v2.2-beta)  
**Convention Start:** November 3, 2025
